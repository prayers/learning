...
\begin{center}
	\parbox{\textwidth}{
		\textbf{摘要}\quad ~《罗马书》在圣经中列在书信的最前面，足见它的重要。马丁路得称《罗马书》为福音摘要；又说基督教只要有《约翰福音》和《罗马书》就不致消灭，仍必发扬光大。他也勉励信徒读这书；他说人可尽量研读《罗马书》，研读得越多，越能发现它的宝藏。加尔文也见证说：任何人若通晓此书，便是找到了一条明白整本圣经的通道。\\
